# **[Scikit-lego](https://scikit-lego.readthedocs.io/en/latest/fairness.html)<span style="text-decoration:underline;"> ([Scikit-fairness](https://github.com/koaning/scikit-fairness) is part of Scikit-lego)</span>**
